...
xst -ifn xst.scr
move MAIN_PLL_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\MAIN_PLL_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc MAIN_PLL_exdes.ucf MAIN_PLL_exdes

echo 'Running map'
map -timing -pr b MAIN_PLL_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm MAIN_PLL_exdes -w routed.ncd routed.vhd
cd ..
